<?php
  ...
  $statement = $conn->prepare("SELECT * FROM contact WHERE id = :id LIMIT 1");
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $statement = $conn->prepare("UPDATE contact SET name = :name, :phone_number = :phone_number WHERE id = :id");
    $statement->execute([
      ":id" => $id,
      ":name" => $_POST["name"],
